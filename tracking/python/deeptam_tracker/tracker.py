...
class TrackerCore:
    ...
    def __init__(self,
        ...
        optimistic_restore(self._session, self._checkpoint, verbose=False)
    ...
    def compute_current_pose(self, image, pose_guess=None):
        ...
        fetch_dict = {
            ...
            'summary': self._tracking_net_output['summary'],
        }
        output = self._session.run(fetch_dict, feed_dict=feed_dict)
        print(fetch_dict['summary'])
        # self._writer.add_summary(fetch_dict['summary'])
